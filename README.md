...
- `docs/architecture/`: engine, awareness stack, Git Context, Branch Comparison, PR Context, CI/CD Context, GitHub Checks Context, Release Workflow Plan, GitHub PR Comment Draft, decision summary, control room, report catalog, operational timeline summary, system blueprint, and `docs/architecture/project-map.md` for contributor orientation.
