...
- `docs/architecture/`: engine, awareness stack, Git Context, PR Context, CI/CD Context, GitHub PR Comment Draft, decision summary, control room, report catalog, operational timeline summary, system blueprint, and `docs/architecture/project-map.md` for contributor orientation.
